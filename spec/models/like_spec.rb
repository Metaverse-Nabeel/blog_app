...
RSpec.describe Like, type: :model do
  let(:user1) { User.create(name: 'Nabeel', photo: 'Url for the image', bio: 'Full Stack Developer', posts_counter: 0) }
  let(:post1) do
    Post.create(author: user1, title: 'title-1', text: 'This is test post', comments_counter: 0,
                likes_counter: 0)
  end
