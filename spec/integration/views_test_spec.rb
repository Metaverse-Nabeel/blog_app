...
RSpec.describe 'User', type: :system do
  before(:each) do
    @profile1 = User.create(name: 'Nabeel',
                            ...
                            post_counter: 0)
    @profile2 = User.create(name: 'Muhammad',
  ...
  before(:each) do
    ...
    @comment2 = Comment.create(author_id: @profile1.id, post_id: @post1.id, Text: 'What is Up')
  ...
  describe 'Show user' do
    ...
    it 'Should show Number of posts by each user' do
      expect(page).to have_content 'User Posts: 4'
    end
  ...
  describe 'post#index' do
    ...
    it 'Number of posts user posted' do
      expect(page).to have_content 'User Posts: 4'
    end
    it 'Post title' do
      expect(page).to have_content 'title 1'
